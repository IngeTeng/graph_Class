...
class Args:
    def __init__(self, data_directory='Graph_datasets/', cuda=False, graph_name='ENZYMES'):
        ...
        self.node_dims = {'MUTAG': 11, 'ENZYMES': 25, 'PROTEINS_full': 80, 'DD': 230,
             'IMDB-BINARY': 134, 'IMDB-MULTI': 88, 'REDDIT-BINARY': 3068, 'REDDIT-MULTI-5K': 88, 'COLLAB':489,'BZR_MD':20,'BeetleFly':5}
        self.num_classes = {'MUTAG': 2, 'ENZYMES': 6, 'PROTEINS_full': 2, 'DD': 2, 
             'IMDB-BINARY': 2, 'IMDB-MULTI': 3, 'REDDIT-BINARY': 2, 'REDDIT-MULTI-5K': 5, 'COLLAB':3,'BZR_MD':2,'BeetleFly':2}
